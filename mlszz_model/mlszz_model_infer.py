...
new_data = pd.read_csv('/Users/andie/PycharmProjects/pyszz_andie/mlszz_model/data/react/bszz_merged_react_features.csv')
...
predictions = (prediction_probabilities >= 0.1).astype(int)
...
output_file_path = '/Users/andie/PycharmProjects/pyszz_andie/mlszz_model/data/react/react_mlszz_output_predictions.csv'
