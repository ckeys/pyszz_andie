...
for project in "${projects[@]}"; do
  ...
  file1="${project}_bic_l.json"
  file2="${project}_bic_ma.json"
  file3="${project}_bic_r.json"
  ...
  if [ ! -f "$project_path/$file3" ]; then
    echo "Warning: File '$file3' does not exist in '$project_path'."
  fi
